...
public abstract class MessageBuilder {
    ...
    private boolean encryptPqcHybrid;
    private boolean signPqcHybrid;
    ...
    public MessageBuilder setSignPqcHybrid(boolean signPqcHybrid) {
        this.signPqcHybrid = signPqcHybrid;
        return this;
    }
