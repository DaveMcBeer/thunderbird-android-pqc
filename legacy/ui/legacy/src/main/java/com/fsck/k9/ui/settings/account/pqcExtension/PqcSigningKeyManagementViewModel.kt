        ...
        viewModelScope.launch {
            ...
            try {
                ...
                withContext(Dispatchers.IO) {
                    val algorithm = account.pqcSigningAlgorithm

                    if (algorithm.isNullOrBlank() || !Sigs.is_sig_enabled(algorithm)) {
                        throw RuntimeException("PQC Siging algorithm '$algorithm' not enabled.")
                    }
